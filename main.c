...
#define TURN_TARGET_TICKS_90 175
...

{
    ...
    while (1)
    {
        ...
        case SETUP_TURN90:
          ...
          case TURN90:
                    left_done = (get_left_motor_count() - left_encoder_zero_pos) > TURN_TARGET_TICKS_90;
                    right_done = (get_right_motor_count() - right_encoder_zero_pos) < -TURN_TARGET_TICKS_90;
